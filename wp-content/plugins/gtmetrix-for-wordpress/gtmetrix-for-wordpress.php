...
HERE;
        ...
        if ( method_exists( $screen, 'add_help_tab' ) ) {
            ...
            switch ( $screen->id ) {
                ...
                case 'toplevel_page_gfw_tests':
                    wp_enqueue_style( 'smoothness', GFW_URL . 'lib/smoothness/jquery-ui-1.9.2.custom.css', GFW_VERSION );
                    $screen->add_help_tab(
                            array(
                                'title' => 'Test',
                                'id' => 'test_help_tab',
                ...
                case 'gtmetrix_page_gfw_schedule':
                    wp_enqueue_style( 'smoothness', GFW_URL . 'lib/smoothness/jquery-ui-1.9.2.custom.min.css', GFW_VERSION );
    ...
    public function credits_meta_box() {
        ...
        <p>Every test costs 1 API credit. You are allotted 20 credits per day. If you need more, you can purchase them from GTmetrix.com.</p>
        <a href="https://gtmetrix.com/pro/" target="_blank" class="button-primary">Get More API Credits</a>
        <?php
    }
    ...
    public function hosting_meta_box() {
        ...
        <a href="http://www.gossamer-threads.com/hosting/wordpress.html" target="_blank" class="button-primary">Get WordPress Optimized Hosting</a>
        <?php
    }
    ...
    public function news_meta_box() {
        ...
        if ( $xml != '' ) {
            for ( $i = 0; $i < 5; $i++ ) {
                ...
                echo '<p>' . $item->description . '</a><br />' . $this->wp_date( $item->pubDate, true ) . '</p>';
            }
        }
    }
